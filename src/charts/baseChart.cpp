...
void BaseChart::updateGradient(Range<qreal> range)
{
  	...
  	gradient->setColorAt(_complianceLevels.veryHigh / delta, RED);
  	gradient->setColorAt(mean(_complianceLevels.low, _complianceLevels.high) / delta, AMBER);
  	gradient->setColorAt(_complianceLevels.veryLow / delta, GREEN);
